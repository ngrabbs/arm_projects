# BenEaterSV - Ben Eater inspired SAP-1 computer in SystemVerilog -> this file was borrowed from here
# SinglCyleArm - Single Cycle ARM processor from Digital Desgin and Computer Architecture - ARM Edition
#
...
YOSYS_SYNTH_OPTS := -device u -abc9
...
clean:
	rm -rf $(LOGS) $(ISIMDIR)/$(ISIMOUT) $(wildcard $(VSIMDIR)/obj_dir/*)
	@cd goboard && make -f Makefile clean
